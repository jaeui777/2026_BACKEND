...
System.out.println( 정수7 % 2 == 1 && 정수7 % 6 == 0 );
...
이름 += 이름.equals("유재석") ? " (방장) " : "" ; // 변수선언 타입명 변수 = 값
...
System.out.println("삼각형의 넓이: " + 삼각형넓이);
...
System.out.println("섭씨온도: "); double 섭씨온도 = scan.nextDouble();
