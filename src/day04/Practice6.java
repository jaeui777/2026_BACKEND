...
int 합계4 = 0;
for( int score : scores1 ) { // : 콜론 기준으로 오른쪽에 배열 , 왼쪽에는 타입 반복변수
  합계4 += score; }
...
int 합계5 = 0;
if( scores2.equals("100")) {System.out.println("100점 만점자를 찾았습니다!");}

for( int score : scores2) {
    if( score == 100) { System.out.println("만점자를 찾았습니다!"); break;}
}
