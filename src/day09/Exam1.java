...
public static void main(String[] args) {
    ...
    ArrayList 클래스 :
        ...
        2. 목적 : 가변길이, 배열관련된 기능(메소드) 제공한다. <관리하다>
        3. 사용법
        ArrayList<제네릭타입> 변수명 = new ArrayList<>();
        - 제네릭타입 : 리스트내 저장할 요소들의 타입, 즉] <String> 리스트 여러개 String 저장
    ...
    //[6] 리스트 요소 총개수
    System.out.println(변수명1.size()); //length가 아니고 size 사용
    //[7] 리스트 특정 요소 출력
    System.out.println(변수명1.get(1)); // 1번 인덱스*두번째) 요소값 호출 가능
    //[8] 리스트 요소 삭제
    변수명1.remove(1);
    System.out.println(변수명1);
    //[9] 리스트 요소 찾기
    System.out.println(변수명1.indexOf("강호동"));  //'강호동'이 찾을 값의 인덱스 반환 없으면 -1
    ...
    // 2. 향상된 for문 , ;콜론기준 오른쪽 리스트내 요소 *하나씩* 왼쪽 변수에 (반복)대
    for(String str : 변수명1);
