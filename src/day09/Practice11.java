...
ArrayList<String> 이름리스트1 = new ArrayList<>();
이름리스트1.add("유재석"); 이름리스트1.add("강호동"); 이름리스트1.add("신동엽");
System.out.println(이름리스트1);
...
알파벳.add("A"); 알파벳.add("B"); 알파벳.add("C"); 알파벳.add("D"); 알파벳.add("E"); 
알파벳.remove(2);
...
IDE.add("자바"); IDE.add("파이썬"); IDE.add("C++");
IDE.add(1, "자바스크립트");
...
for (;;) {String 단어 = scan.nextLine();
    if ("종료".equals(단어)) {break;}
    ABC.add(단어);}
